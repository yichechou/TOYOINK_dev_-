                ...
                try
                {
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if ((i != dt.Rows.Count - 1 && (dt.Rows[i]["TD002"].ToString() != dt.Rows[i + 1]["TD002"].ToString())) || i == dt.Rows.Count - 1)
                        {
                            ...
                            ",COPMA.MA027 as TC010,COPMA.MA064 as TC011,CFIPO.ERP_客單 as TC012,COPMA.MA030 as TC013,COPMA.MA031 as TC014" + str_enter +
                            ...
                            ",'' as TC062,COPMA.MA024 as TC063,COPMA.MA026 as TC064,COPMA.MA003 as TC065,COPMA.MA006 as TC066" + str_enter +
