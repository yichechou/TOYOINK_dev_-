            ...
            if (err == false)
            {
                ...
                string sql_str_Statement = String.Format(
                    ...
                    FROM [A01A].[dbo].ACRTB
                        ...
                        where  TA001 in ('610T','615T','640T','650T','660T','661T','C61T','C64T','C65T','C66T','U61T','U66T')
                        and TA025 ='Y' and TA004 not in ('TCE','TCET','ETOP') and TB004 <> '9'
                        and TA032 >= '{0}' and TA032 <= '{1}'
                        order by TA032,TB001,TA003", str_date_m_s, str_date_m_e);
                ...
                string sql_str_OrderList = String.Format(
                    ...
                    where TH020 = 'Y' and TH026 = 'Y' and TB004 <>'9' and TH027 = 'C61T' and TH001 = 'C2SH'
                    and TG004 in('Y-PP0001','Y-PP0002','Y-PP0003','Y-PP0004','Y-PP0005','Y-PP0006','Y-PP0007','Y-PP0008','Y-PP0009','Y-PP0010','Y-PP0011','Y-PP0012','Y-PP0013','Y-PP0014','Y-PP0015','Y-PP0016','Y-PP0017','Y-ERS002','Y-ECH001','TIPPS','JCM')
                    and left(TG003,6) >= '{0}' and left(TG003,6) <= '{1}' 
                    group by TG004,MA002,MB006,TH004
                    order by MB006", str_date_y_e + "01", str_date_m_e);
                ...
                string sql_str_Order = String.Format(
                    ...
                    and TG004 in('Y-PP0001','Y-PP0002','Y-PP0003','Y-PP0004','Y-PP0005','Y-PP0006','Y-PP0007','Y-PP0008','Y-PP0009','Y-PP0010','Y-PP0011','Y-PP0012','Y-PP0013','Y-PP0014','Y-PP0015','Y-PP0016','Y-PP0017','Y-ERS002','Y-ECH001','TIPPS','JCM')
                    and left(TG003,6) >= '{0}' and left(TG003,6) <= '{1}' 
                    order by MB006,TG003", str_date_y_e + "01", str_date_m_e);
                ...
                string sql_str_CustOrderList = String.Format(
                    ...
                    where 確認碼 = 'Y' and 結帳碼 = 'Y'
                    and 客戶代號 in('Y-PP0001','Y-PP0002','Y-PP0003','Y-PP0004','Y-PP0005','Y-PP0006','Y-PP0007','Y-PP0008','Y-PP0009','Y-PP0010','Y-PP0011','Y-PP0012','Y-PP0013','Y-PP0014','Y-PP0015','Y-PP0016','Y-PP0017','Y-ERS002','Y-ECH001','TIPPS','JCM')
                    and 年月 >= '{0}' and 年月 <= '{1}'
                    group by 客戶代號,客戶簡稱,品種別", str_date_y_e + "01", str_date_m_e);
                ...
                string sql_str_CustOrder = String.Format(
                    ...
                    and 客戶代號 in('Y-PP0001','Y-PP0002','Y-PP0003','Y-PP0004','Y-PP0005','Y-PP0006','Y-PP0007','Y-PP0008','Y-PP0009','Y-PP0010','Y-PP0011','Y-PP0012','Y-PP0013','Y-PP0014','Y-PP0015','Y-PP0016','Y-PP0017','Y-ERS002','Y-ECH001','TIPPS','JCM')
                    and 年月 >= '{0}' and 年月 <= '{1}'
                    group by 客戶代號,客戶簡稱,品種別,品號,品名,單位", str_date_y_e + "01", str_date_m_e);
            ...
            using (XLWorkbook wb_Trademark = new XLWorkbook())
            {
                ...
                foreach (DataRow row in dt_Order.Rows)
                {
                    ...
                    if ((rows_count_Order - 1) == dt_Order.Rows.IndexOf(row)) //資料列結尾運算
                    {
                        ...
                        wsheet_Order.Cell(m + 5, 14).Style.NumberFormat.Format = "#,##0_);[RED](#,##0)";
                        wsheet_Order.Cell(m + 5, 14).FormulaA1 = "=SUMIF(E:E,\"C2SH\",N:N)";
                    }
                ...
                save_as_Trademark = txt_path.Text.ToString().Trim() + @"\\商標權" + txt_date_s.Text.ToString().Substring(0, 6) + "_" + DateTime.Now.ToString("yyyyMMdd") + @".xlsx";
